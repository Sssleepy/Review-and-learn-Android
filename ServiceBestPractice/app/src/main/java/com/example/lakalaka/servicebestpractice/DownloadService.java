...
public class DownloadService extends Service {
    ...
    private Notification getNotification(String title, int progress) {
        ...
        bulider.setLargeIcon(BitmapFactory.decodeResource(getResources(), R.mipmap.ic_launcher));
        bulider.setContentIntent(pi);
        bulider.setContentTitle(title);
        if (progress > 0) {
//            当progress 大于0时显示进度
            bulider.setContentText(progress + "%");
            bulider.setProgress(100, progress, false);
        }
